...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 07 Tem 2020, 16:02:48
...
(2, 'Favipiravir', '<p>Normal</p>\r\n', 'Yeni Başladı', '2020-06-07', '', 111111111),
(3, 'Aferin 2020 ', '<p>Acil</p>\r\n', 'Yeni Başladı', '2020-05-26', 'Kapsül', 2147483647),
...
(9, 'arvales', 'Acil', 'Yeni Başladı', '2020-06-13', 'Kapsül', 222);
...
(1, 'Gaziler ECZANESİ	', 'Gaziler ÖZEL AKDEMİ KBB BİTİŞİĞİ LEVENT LOJMANLARI KARŞISI NO:7/E	', '2020-03-20', 2287027, 'BAĞLAR', 'LEVENT LOJM.'),
...
(8, 'Diyarbakır Eczanesi', 'BAĞLAR SENTO CAD. NO:116/C Döryol KAVŞAĞI BAĞLAR	', '2020-06-07', 555555555, 'BAĞLAR', 'Dörtyol'),
(9, 'Diyarbakır Eczanesi', 'BAĞLAR SENTO CAD. NO:116/C Döryol KAVŞAĞI BAĞLAR	', '2020-06-07', 555555555, 'BAĞLAR', 'Dörtyol'),
(10, 'Huzur Eczanesi', 'BAĞLAR SENTO CAD. NO:116/C Döryol KAVŞAĞI BAĞLAR	', '2020-06-07', 555555555, 'Kayapınar', 'Huzurevleri');
...
(37, 'Evin Eczanesi', 'evin@gmail.com', 55555555555, '2020-06-12', 'Normal', 'Yeni Başladı', '', 30, 'ARVELES '),
...
--
ALTER TABLE `nobetci_eczane`
  MODIFY `ne_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
