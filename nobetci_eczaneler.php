...
<div class="container-fluid">
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-2 text-gray-800">Nöbetçi Eczane</h1>
  <p class="mb-4">Bu alandan Nöbetçi Eczane bilgileri görüntüleyebilir ve dışa aktarabilirsiniz.</p>
  <!-- DataTales Giriş -->
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">Nöbetçi Eczane Bilgileri</h6>
    </div>
    ...
    <div class="table-responsive">
      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
			<?php 
				$sayi=0;
				$nesor=$db->prepare("SELECT * From nobetci_eczane");
				$nesor->execute();
						
				while($necek=$nesor->fetch(PDO::FETCH_ASSOC)) {
							$sayi++; 		?>					
							
						<tr>
							<td><?php echo $sayi ?></td>
							<td><?php echo $necek['ne_adi']	?></td>
							<td><?php echo $necek['ne_adres']	?></td>
							<td><?php echo $necek['ne_telefon']	?></td>
							<td><?php echo $necek['ne_gun']	?></td>
							<td><?php echo $necek['ilce']	?></td>
							<td><?php echo $necek['bolge'] ?></td>
							<td>
							
							
						
		 <div class="d-flex justify-content-center">
              <form action="neduzenle.php" method="POST">
                <input type="hidden" name="ne_id" value="<?php echo $necek['ne_id'] ?>">
                <button type="submit" name="neduzenleme" class="btn btn-success btn-sm btn-icon-split">
              ...
              <form class="mx-2" action="islemler/islem.php" method="POST">
                <input type="hidden" name="ne_id" value="<?php echo $necek['ne_id'] ?>">
                <button type="submit" name="ne_sil" class="btn btn-danger btn-sm btn-icon-split">
                  <span class="icon text-white-60">
            ...
            <form action="nobetci_eczanler.php" method="POST">
              <input type="hidden" name="ne_id" value="<?php echo $necek['ne_id'] ?>">
              <button type="submit" name="ne_bak" class="btn btn-primary btn-sm btn-icon-split">
                <span class="icon text-white-60">
